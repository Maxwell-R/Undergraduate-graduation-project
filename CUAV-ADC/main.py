...
def GetLine(NodeNum, Node, K, ComR):
    ...
    for i in range(Blist.__len__()):
        ...
        if IfMeetCluster == 1:
            break
    for i in range(BeginX.__len__() - 1):
        if i % 2 == 0:
    ...
    if flag == 1:
        return [BeginX[0], BeginX[0] * K + Blist[0],
                BeginX[BeginX.__len__() - 1], BeginX[BeginX.__len__() - 1] * K + Blist[BeginX.__len__() - 1]], Length
    if flag == 0:
        return [BeginX[0], BeginX[0] * K + Blist[0],
                EndX[EndX.__len__() - 1], EndX[EndX.__len__() - 1] * K + Blist[BeginX.__len__() - 1]], Length
